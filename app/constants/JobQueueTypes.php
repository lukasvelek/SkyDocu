...
class JobQueueTypes extends AConstant {
    ...
    /**
     * Cancel a process instance in a container
     */
    public const CANCEL_CONTAINER_PROCESS_INSTANCE = 5;
    ...
    public static function toString($key): ?string {
        return match((int)$key) {
            ...
            self::CANCEL_CONTAINER_PROCESS_INSTANCE => 'Cancel container process instance'
        };
    }
}
